...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const animatedElements = document.querySelectorAll('.animate-on-scroll, .section-header, .about-grid, .scholarship-card, .testimonial-card, .application-form, .contact-grid');
    ...
    const interactiveElements = document.querySelectorAll('.btn, .nav-link, .scholarship-card, .testimonial-card');
